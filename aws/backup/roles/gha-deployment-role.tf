...
data "aws_iam_policy_document" "codebuild_assume_role_policy" {
  ...
  statement {
    ...
    principals {
      type = "AWS"
      identifiers = ["arn:aws:sts::696793786584:assumed-role/AWSReservedSSO_AWSAdministratorAccess_595eb2c361766093/erastus.ndi@kainos.com",
      "arn:aws:sts::696793786584:assumed-role/AWSReservedSSO_AWSAdministratorAccess_595eb2c361766093/konrada@kainos.com"]
    }
  }
