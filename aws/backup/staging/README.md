...
| [aws_vpc.prod_vpc](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/vpc) | data source |
...
| <a name="input_prod_codebuild_security_group_id"></a> [prod\_codebuild\_security\_group\_id](#input\_prod\_codebuild\_security\_group\_id) | Staging ENV Codebuild Security Group ID | `string` | `"sg-01159fd096141d05d"` | no |
| <a name="input_prod_private_subnet_id"></a> [prod\_private\_subnet\_id](#input\_prod\_private\_subnet\_id) | Staging ENV Private Subnet ID | `string` | `"subnet-02472f2532377d2b4"` | no |
| <a name="input_prod_vpc_id"></a> [prod\_vpc\_id](#input\_prod\_vpc\_id) | Staging ENV VPC ID | `string` | `"vpc-01170654bdfd5e6b8"` | no |
