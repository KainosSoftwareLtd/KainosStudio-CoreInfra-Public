...
data "aws_iam_policy_document" "codebuild_assume_role_policy" {
  ...
  statement {
    ...
    principals {
      type = "AWS"
      identifiers = ["arn:aws:sts::696793786584:assumed-role/AWSReservedSSO_AWSAdministratorAccess_1a26381ad3e03eea/erastus.ndi@kainos.com",
        "arn:aws:sts::696793786584:assumed-role/AWSReservedSSO_AWSAdministratorAccess_1a26381ad3e03eea/konrada@kainos.com",
      "arn:aws:sts::696793786584:assumed-role/AWSReservedSSO_AWSAdministratorAccess_1a26381ad3e03eea/nick.moynihan@kainos.com"]
    }
  }
  ...
  statement {
    ...
    principals {
      type        = "Federated"
      identifiers = ["arn:aws:iam::696793786584:oidc-provider/token.actions.githubusercontent.com"]
    }
