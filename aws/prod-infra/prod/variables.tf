...
variable "prod_vpc_id" {
  type        = string
  description = "Prod ENV VPC ID"
  default     = "vpc-01ed446351b6f0134"
}

variable "prod_private_subnet_id" {
  type        = string
  description = "Prod ENV Private Subnet ID"
  default     = "subnet-0585af41c63bcfc65"
}

variable "prod_codebuild_security_group_id" {
  type        = string
  description = "Prod ENV Codebuild Security Group ID"
  default     = "sg-0b75b6a40c4d65b54"
...
variable "apigateway_vpc_endpoint" {
  type        = string
  description = "API Gateway VPC Endpoint for prod"
  default     = "vpce-02a4d1a67ab19e5e0"
