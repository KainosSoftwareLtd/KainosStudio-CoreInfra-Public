...
| <a name="input_apigateway_vpc_endpoint"></a> [apigateway\_vpc\_endpoint](#input\_apigateway\_vpc\_endpoint) | API Gateway VPC Endpoint for prod | `string` | `"vpce-030ed18075112e5c3"` | no |
...
| <a name="input_prod_codebuild_security_group_id"></a> [prod\_codebuild\_security\_group\_id](#input\_prod\_codebuild\_security\_group\_id) | Prod ENV Codebuild Security Group ID | `string` | `"sg-0a8b5248caac1c5e9"` | no |
| <a name="input_prod_private_subnet_id"></a> [prod\_private\_subnet\_id](#input\_prod\_private\_subnet\_id) | Prod ENV Private Subnet ID | `string` | `"subnet-0afb974b6d47664d9"` | no |
| <a name="input_prod_vpc_id"></a> [prod\_vpc\_id](#input\_prod\_vpc\_id) | Prod ENV VPC ID | `string` | `"vpc-058d3fa1e03d9160d"` | no |
