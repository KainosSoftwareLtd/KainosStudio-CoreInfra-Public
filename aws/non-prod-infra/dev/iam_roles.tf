...
# API Gateway Logging Role and Policies
...
resource "aws_iam_policy" "api_gateway_logging_policy" {
  name        = "APIGatewayCloudWatchLogsPolicy-KainosStudio"
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:logs:${var.region}:${data.aws_caller_identity.current.account_id}:log-group:/aws/apigateway/*"
      }
    ]
  })
...
# Attach the policy to the API Gateway logging role
resource "aws_iam_role_policy_attachment" "api_gateway_logging_role_attachment" {
