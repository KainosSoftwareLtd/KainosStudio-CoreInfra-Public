...
variable "staging_vpc_id" {
  type        = string
  description = "Staging ENV VPC ID"
  default     = "vpc-01170654bdfd5e6b8"
}

variable "staging_private_subnet_id" {
  type        = string
  description = "Staging ENV Private Subnet ID"
  default     = "subnet-02472f2532377d2b4"
}

variable "staging_codebuild_security_group_id" {
  type        = string
  description = "Staging ENV Codebuild Security Group ID"
  default     = "sg-01159fd096141d05d"

}

variable "gha_codebuild_service_role_name" {
  type        = string
  description = "GHA-CodeBuild Service Role"
...
variable "apigateway_vpc_endpoint" {
  type        = string
  description = "API Gateway VPC Endpoint for stagin"
  default     = "vpce-030ed18075112e5c3"
...
variable "assume_role_arn" {
  ...
  type        = string
  default     = "arn:aws:iam::975050265283:role/GHA-CodeBuild-Service-Role"
}
