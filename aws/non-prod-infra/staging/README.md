...
| [aws_vpc.staging_vpc](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/vpc) | data source |
...
| <a name="input_apigateway_vpc_endpoint"></a> [apigateway\_vpc\_endpoint](#input\_apigateway\_vpc\_endpoint) | API Gateway VPC Endpoint for stagin | `string` | `"vpce-030ed18075112e5c3"` | no |
...
| <a name="input_env"></a> [env](#input\_env) | Environment | `string` | `"staging"` | no |
| <a name="input_gha_codebuild_service_role_name"></a> [gha\_codebuild\_service\_role\_name](#input\_gha\_codebuild\_service\_role\_name) | GHA-CodeBuild Service Role | `string` | `"GHA-CodeBuild-Service-Role"` | no |
...
| <a name="input_staging_codebuild_security_group_id"></a> [staging\_codebuild\_security\_group\_id](#input\_staging\_codebuild\_security\_group\_id) | Staging ENV Codebuild Security Group ID | `string` | `"sg-01159fd096141d05d"` | no |
| <a name="input_staging_private_subnet_id"></a> [staging\_private\_subnet\_id](#input\_staging\_private\_subnet\_id) | Staging ENV Private Subnet ID | `string` | `"subnet-02472f2532377d2b4"` | no |
| <a name="input_staging_vpc_id"></a> [staging\_vpc\_id](#input\_staging\_vpc\_id) | Staging ENV VPC ID | `string` | `"vpc-01170654bdfd5e6b8"` | no |
