...
output "core_api_name" {
  description = "Name of the Core API"
  value       = azurerm_api_management_api.core_api.name
}

output "kfd_upload_api_name" {
  description = "Name of the KFD Upload API"
  value       = azurerm_api_management_api.kfd_upload_api.name
}

output "kfd_delete_api_name" {
  description = "Name of the KFD Delete API"
  value       = azurerm_api_management_api.kfd_delete_api.name
}
